...
TOTAL_P=0; TOTAL_F=0
for s in verify-h1-keyword verify-keyword-coverage verify-images-titles verify-robots-media verify-forms-and-features verify-area-depth verify-new-areas \
